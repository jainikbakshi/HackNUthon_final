def Scraper():
    import requests
    import random
    keywords=['Bomb','Explosive','Hostage','Hijack','Attack','Jihad','Radicalization','Suicide','Terrorist','Weapon',
          'Al-Qaida','Boko Haram','ISIS','Hamas','Taliban','Hezbollah','Suicide bomber','Jihad',
          'Narcotics','Marijuana','Cocaine','Heroin','Opioids','Drug trafficking','Drug cartel','Phishing',
          'Hacktivism','Antisemitism','Militant group',
          'Jihadist','Cyber-jihad','Cyber terrorism financing','Religious ','fanaticism',
          'Cyberterrorism training','Terrorist funding','Drugs','Terrorism','coup',
          'Narcotics trade','guns','ammunition','guns','phishing','Hostage','Improvised Explosive Device',
          'RDX','Anthrax']
    
    yourquery = random.choice(keywords)
    print(yourquery)
    if " " in yourquery:
